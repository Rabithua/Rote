...
function Landing() {
  ...
  return (
    <div className=" bg-bgWhite dark:text-white dark:bg-bgDark w-full min-h-dvh flex flex-col justify-center items-center">
          ...
          <div className=" flex flex-wrap items-center font-semibold font-mono text-xl md:text-3xl whitespace-pre-wrap">
            ...
            {links.map((item, index) => {
              return (
                <div key={"link-" + index}>
                  <Link
                    to={profile && item.href ? "/home" : item.href}
