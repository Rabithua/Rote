        ...
        <div className=" cursor-default bg-white w-full flex gap-5">
            <div className=" w-[90%] flex-1">
                <TextArea
                    ...
                    className={` text-base lg:text-lg text-pretty ${editType === "default" ? "" : " hidden"
                        }`}
                    maxLength={3000}
                    onInput={(e) => {
                        setNewRote({
                ...
                <Select
                    mode="tags"
                    variant="borderless"
                    className={` bg-[#00000005] my-2 rounded-md border border-[#00000010] w-fit min-w-40 max-w-full ${tagsShow ? "" : "hidden"
                        }`}
                    value={newRote.tags}
                    placeholder="标签"
                ...
                <div className=" flex flex-wrap gap-2 overflow-x-scroll noScrollBar">
                    <TagsOutlined
                        ...
                        className={` cursor-pointer text-xl p-2 hover:bg-[#00000005] rounded-md ${tagsShow ? " bg-[#00000010]" : ""
                            }`}
                    />
                    <PushpinOutlined className={` cursor-pointer text-xl p-2 rounded-md ${newRote.pin ? 'bg-[#00000010]' : ''}`}
                        onClick={() => {
                            setNewRote({
                                ...newRote,
                                pin: !newRote.pin
