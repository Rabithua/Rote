...
To provide you with our services, we may collect the following types of information and will only use them for the clear and specific purposes described below:
...
- **Device and Log Information**: We may collect anonymized or de-identified data such as device model, operating system version, IP address, browser information, and crash logs, used only for security protection (e.g., detecting abnormal behavior, preventing abuse) and app performance analysis, not for identifying your real-world identity.
...
We will not sell your personal information to any third party. We may share your information only under the following limited circumstances:
...
You have the following rights with respect to your personal information, and we will respect and support the exercise of these rights in accordance with applicable laws:

- **Access and Correction**: You can log in to your account at any time to view and edit your profile and stored content. If you self-host the backend, you may also access and export data directly through database management or backups.
- **Deletion and Account Closure**: You can delete individual notes or attachments in the App, or request deletion of your account and related data. If you self-host the backend, you can also delete all stored data by destroying servers, storage volumes, or backups under your control.
- **Withdraw Consent**: For processing activities based on your consent, you may withdraw your consent at any time. Withdrawal of consent will not affect the lawfulness of processing carried out based on consent before its withdrawal, but may result in some features no longer being available.

---

## 7. Privacy Policy Revisions

We may update this privacy policy from time to time due to changes in laws, regulations, or our services. Updated versions will be published within the App or on related pages. Your continued use of the App after the updated policy takes effect will be deemed as your acceptance of the updated policy. For material changes, we will provide more prominent notice or in-app messages where appropriate.

---

## 8. Contact Us

If you have any questions, comments, or suggestions regarding this privacy policy or our handling of your personal information, please contact us via:
